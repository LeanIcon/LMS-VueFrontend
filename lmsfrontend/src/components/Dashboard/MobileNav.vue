   ...
   <div class="nav-container">
      <div class="nav-links">
         <ul class="nav-list row">
            <!-- home tab  -->
            <router-link :to="{ name:'Dashboard' }" exact tag="li" class="nav-icon navigation col" class-active="active">
            ...
            <router-link :to="{ name:'Skill' }" exact tag="li" class="nav-icon navigation col" class-active="active">
               <!-- quiz tab  -->
            ...
            <router-link :to="{ name:'Editprofile' }" exact tag="li" class="nav-icon navigation col" class-active="active">
