    ...
    <div class="sidebar-container">
        <div class="sidebar-rect">
            ...
            <div class="icon-fonts">
                ...
                <!-- <router-link :to = "{ name:'Dashboard' }" exact> -->
                <router-link :to="{ name:'Dashboard' }" exact tag="div" class="home-tab menu-tab" class-active="active" >
                        <div class="menu-items">
                            <div class="home-tab tab-icons">
                                <!-- <img src="../assets/home-icon.png" alt="home icon"> -->
                                <svg viewBox="0 0 29.001 30.001">
                                    <path fill="white"
                                        d="M 21.78359985351562 30.00060081481934 C 21.23100090026855 30.00060081481934 20.78370094299316 29.55240058898926 20.78370094299316 28.99980163574219 L 20.78370094299316 17.41950035095215 L 23.00040054321289 17.41950035095215 C 26.31420135498047 17.41950035095215 29.00069999694824 20.10600090026855 29.00069999694824 23.4197998046875 L 29.00069999694824 30.00060081481934 L 21.78359985351562 30.00060081481934 Z M 11.15010070800781 30.00060081481934 C 10.59749984741211 30.00060081481934 10.15019989013672 29.55240058898926 10.15019989013672 28.99980163574219 L 10.15019989013672 0 L 12.36690044403076 0 C 15.68070030212402 0 18.36720085144043 2.686500072479248 18.36720085144043 6.00029993057251 L 18.36720085144043 30.00060081481934 L 11.15010070800781 30.00060081481934 Z M 0.9999000430107117 30.00060081481934 C 0.4473000168800354 30.00060081481934 0 29.55240058898926 0 28.99980163574219 L 0 10.64520072937012 L 1.733399987220764 10.64520072937012 C 5.047200202941895 10.64520072937012 7.733700275421143 13.33170032501221 7.733700275421143 16.64550018310547 L 7.733700275421143 30.00060081481934 L 0.9999000430107117 30.00060081481934 Z">
                                    </path>
                                </svg>
                ...
                <router-link :to="{ name:'Courseregister' }" exact tag="div" class="course-tab menu-tab" class-active="active" >
                    <div class="menu-items">
                        <div class="course-tab tab-icons">
                            <!-- <img src="../assets/course-icon.png" alt="course icon"> -->
                            <svg viewBox="1 3 46.437 37.994">
                                <path fill="white"
                                    d="M 9.443034172058105 24.48752212524414 L 9.443034172058105 32.93055725097656 L 24.21834373474121 40.99365234375 L 38.99365234375 32.93055725097656 L 38.99365234375 24.48752212524414 L 24.21834373474121 32.55062103271484 L 9.443034172058105 24.48752212524414 Z M 24.21834373474121 3 L 1.00000011920929 15.66455078125 L 24.21834373474121 28.32910346984863 L 43.21516799926758 17.96527862548828 L 43.21516799926758 32.55062103271484 L 47.43668746948242 32.55062103271484 L 47.43668746948242 15.66455078125 L 24.21834373474121 3 Z">
                                </path>
                            </svg>
                        </div>
