      ...
      <div class="_content h-100">
        ...
        <div class="row section">
          <div class="col-9 col-md-6 col-sm-8 col-lg-6 _c1 d-flex">
            ...
            <div class="sub_text mr-5">
              <p>
                Get rid of exam nerves long before you have to do the real
                thing. You can take as many practice exams as you need to feel
                confident heading into exam day.
              </p>
            </div>
            <div class="spacer-2x"></div>
            <div class="row">
              ...
              <div
                class="
                  col-md-6 col-sm-6 col-xl-8 col-lg-6 col-12
                  video-btn
                  d-flex
                "
              >
