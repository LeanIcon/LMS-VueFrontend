<template>
   <div class="container">
      <div class="error">
            <h1>500</h1>
            <h2>error</h2>
            <p>You may be getting this message if there's an issue that prevents the system from completing an action. If you still get this message after 1 hour, Try these options below:</p>
            <ul style="text-align:left">
               <li>Clear the cache and cookies from your browser.</li>
               <li>Try a different browser. For example, if you use Internet Explorer, access LiTT Learning using Firefox, Chrome, or Safari.</li>
               <li>If you don't have the latest browser version, download the most current update.</li>
            </ul>
      </div>
